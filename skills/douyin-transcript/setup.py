...
# 自动推断：python.exe 位于 .../python/versions/<ver>/python.exe，venv 同级在 .../python/envs/default
BASE_PYTHON = sys.executable
VENV_DIR = Path(BASE_PYTHON).resolve().parent.parent.parent / "envs" / "default"
